from utils.rag import build_vector_store, process_pdf, retrieve_relevant_docs
from utils.web import web_search
...
def get_chat_response(chat_model, messages, system_prompt):
    ...
    try:
        ...
        return st.write( "Something went wrong while fetching the response.")
...
#     # === Sidebar options ===
    with st.sidebar:
        ...
        try:
            ...
            st.write( "Failed to read PDF. Please try again.")
    ...
    if prompt := st.chat_input("Type your message here..."):
        ...
        with st.chat_message("assistant"):
            with st.spinner("Getting response..."):
                 # Step 1: Try retrieving from RAG
                context_docs = retrieve_relevant_docs(prompt)
